...
const (
	KeyUsageDigitalSignature x509.KeyUsage = 1 << iota
...
const (
	ExtKeyUsageAny x509.ExtKeyUsage = iota
...
// c's public key.
func (c *Certificate) CheckSignature(algo x509.SignatureAlgorithm, signed, signature []byte) (err error) {
